...
function ProjectList({ projects, setProjects }) {
    ...
    useEffect(() => {
        var model_json = {
         ...
         axios.post('https://project-management-portal-two.vercel.app/getAllDocuments',model_json)
             .then((response) => {
    ...
    const handleCreateProject = () => {
        if (projectName.trim() !== '') {
            ...
            axios.post('https://project-management-portal-two.vercel.app/insertDocument',Model_json)
            .then((response) => {
    ...
    const handleDeleteProject = (projectId) => {
        ...
        axios.post('https://project-management-portal-two.vercel.app/deleteDocument',model_json)
            .then((response) => {
                console.log(response);
            })
            .catch((error) => {
    ...
    const handleEditProject = (projectId) => {
        const updatedProjects = projects.map(project => {
            if (project.id === projectId) {
                ...
                axios.post('https://project-management-portal-two.vercel.app/updateDocument',model_json)
